...
def create_password():
    service_name = service_input.text()                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             xt()
...
def  update_slider_label():
    slider_label.setText(f"довжина пароля {slider.value()}")
...
slider_label = QtWidgets.QLabel("Довжина пароля: 10" , dialog)
slider_label.setGeometry(340, 230, 200,20)
